...
<body>
    <div class="floodblocker">
        <img alt="{PAGE_TITLE}" src="{IMG_SRC}" width="{IMG_WIDTH}" height="{IMG_HEIGHT}" /> <br /> {FLOOD_BLOCKER_INFO1}. <br /> <span>{FLOOD_BLOCKER_INFO2} <span id="secField">{FLOOD_BLOCKER_TIME}</span> {FLOOD_BLOCKER_INFO3}...
        </span>
    </div>

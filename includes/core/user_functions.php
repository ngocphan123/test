...
function nv_html_links($html = true)
{
    ...
    if (!empty($id_profile_googleplus)) {
        ...
        if (isset($dbgoogleplus[$id_profile_googleplus]['idprofile'])) {
            $return[] = array(
                'rel' => 'author',
                'href' => 'https://plus.google.com/' . $dbgoogleplus[$id_profile_googleplus]['idprofile']
            );
        }
    }
    ...
    if (file_exists(NV_ROOTDIR . '/themes/' . $module_info['template'] . '/css/' . $module_info['module_theme'] . '.css')) {
        if ($html) {
            ...
            return array(
                array(
                    'rel' => 'StyleSheet',
                    'href' => NV_BASE_SITEURL . "themes/" . $module_info['template'] . "/css/" . $module_info['module_theme'] . ".css"
                )
            );
        }
        ...
        if ($html) {
            ...
            return array(
                array(
                    'rel' => 'StyleSheet',
                    'href' => NV_BASE_SITEURL . "themes/" . $module_info['template'] . "/css/" . $module_file . ".css"
                )
            );
        }
    }
